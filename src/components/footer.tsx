        ...
        <div className="flex gap-6 items-center whitespace-nowrap animate-scroll" style={{ width: 'max-content' }}>
          {[...Array(8)].map((_, group) => (
            <div key={group} className="flex gap-6 items-center flex-shrink-0">
              <Image src="https://i.ibb.co/gL0mLH1m/Clash-MMALogo.png" alt="Clash MMA" width={80} height={50} className="h-12 w-auto" suppressHydrationWarning={true} />
              <Image src="https://i.ibb.co/XxHbj8Cd/04be6464-9300-4243-b4ee-6054050870e7.png" alt="Sponsor 2" width={80} height={50} className="h-12 w-auto" suppressHydrationWarning={true} />
              <Image src="https://i.ibb.co/MxFqjSYj/7u7logo-1.png" alt="7u7" width={80} height={50} className="h-12 w-auto" suppressHydrationWarning={true} />
              <Image src="https://i.ibb.co/xbrWSnb/Przezroczyste-PFF.png" alt="PFF" width={80} height={50} className="h-12 w-auto" suppressHydrationWarning={true} />
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="border-t border-white/10 pt-6 flex flex-wrap items-center justify-between gap-4 text-xs">
            ...
            <div className="flex gap-6">
              <Link href="/polityka-prywatnosci" className="text-gray-400 hover:text-white transition-colors">Polityka Prywatności</Link>
              <Link href="/tos" className="text-gray-400 hover:text-white transition-colors">Regulamin</Link>
